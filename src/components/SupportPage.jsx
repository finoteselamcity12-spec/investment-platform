        ...
        <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-bold text-slate-950 flex items-center gap-2">
                  <MessageCircle size={20} style={{ color: PRIMARY_BLUE }} />
                  Telegram
                </h3>
                <p className="text-xs text-slate-500 mt-2">@investment_platform_3</p>
              </div>
              <ExternalLink size={20} style={{ color: PRIMARY_BLUE }} />
            </div>
          </a>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-bold text-slate-950 flex items-center gap-2">
                  <Mail size={20} style={{ color: PRIMARY_BLUE }} />
                  Email Support
                </h3>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-bold text-slate-950 flex items-center gap-2">
                  <Phone size={20} style={{ color: PRIMARY_BLUE }} />
                  Phone
                </h3>
