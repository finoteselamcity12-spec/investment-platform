-- =============================================================================
-- RUN_ADMIN_APPROVE_DEPOSIT.sql
-- Paste into Supabase SQL Editor → Run once
-- Fixes: admin dashboard "admin_approve_deposit" RPC missing (404)
-- After running: Settings → API → Refresh schema (or wait for NOTIFY below)
-- =============================================================================
...
-- Frontend calls: supabase.rpc('admin_approve_deposit', { p_deposit_id: '<uuid>' })
