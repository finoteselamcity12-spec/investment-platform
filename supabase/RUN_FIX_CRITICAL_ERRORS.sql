-- =============================================================================
-- RUN_FIX_CRITICAL_ERRORS.sql — paste into Supabase SQL Editor and Run once
-- Resolves:
--   1) grant_signup_bonus_if_missing RPC 404
--   2) deposits RLS 403 on INSERT
--   3) history table / action constraint for welcome_bonus queries
-- (Same as migrations/013_fix_critical_supabase_errors.sql)
-- =============================================================================
