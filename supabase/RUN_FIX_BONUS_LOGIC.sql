...
WHERE NOT EXISTS (
  SELECT 1 FROM public.bonus_history h
...
BEGIN
  ...
  INSERT INTO public.bonus_history (user_id, action, currency, amount, reference_id, metadata)
  VALUES (
    dep.user_id,
    'deposit_bonus',
    norm_currency,
